...
// }
  ...
  function createMap() {
    ...
    map = new mapboxgl.Map({
        ...
        center: [-94, 46], // starting position [lng, lat]
...
//               // provided.
//               var siteLat =
//                 (taxaSliceSite.LatitudeNorth + taxaSliceSite.LatitudeSouth) / 2;
//               var siteLon =
//                 (taxaSliceSite.LongitudeEast + taxaSliceSite.LongitudeWest) / 2;
...
//             // siteID is arbitrary
//             if (
//               currentSite.siteID == 1815 &&
//               taxaSliceSite.Age < 1001 &&
//               taxaSliceSite.TaxonName == "Picea"
//             ) {
    ...
    for (var j = 0; j < variableArray.length; j++) {
      for (var variable in period) {
        ...
        if (variableArray[j] == variable) {
          ...
          // popupContent +=
          //   "<p><b>% abundance:</b> <br>" + round(value, 2) + "</p>";
          // popupContent +=
          //   "<p id='popup-site' value='" +
          //   site.siteID +
          //   "'><b>Site ID:</b> <br>" +
          //   site.siteID +
          //   "</p>";
          // popupContent +=
          //   "<p id='popup-site'><b>Site Name:</b> <br>" + site.name + "</p>";
...
//     var barChartMarker = new L.BarChartMarker(
